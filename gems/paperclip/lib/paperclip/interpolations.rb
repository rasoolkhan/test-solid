module Paperclip
  ...
  module Interpolations
    ...
    def sid attachment, style_name
      viewable = attachment.instance.viewable
      if viewable.class == Spree::ProductSample
        viewable.store.id
      elsif viewable.class == Spree::Product
        viewable.store.id
      elsif viewable.class == Spree::Store
        viewable.id
      else
        viewable.product.store.id
      end
    end

    def pid attachment, style_name
      viewable = attachment.instance.viewable
      if viewable.class == Spree::ProductSample
        0
      elsif viewable.class == Spree::Product
    ...
    def slug attachment, style_name
      viewable = attachment.instance.viewable
      if viewable.class == Spree::ProductSample
        viewable.store.slug
      else
        viewable.product.slug
      end
    end
  end
end
