...
ActiveRecord::Schema.define(version: 20160119110157) do
  ...
  create_table "spree_bank_details", force: :cascade do |t|
    t.integer "seller_id"
    t.string  "bank_name"
    t.string  "branch"
  ...
  add_index "spree_bank_details", ["seller_id"], name: "index_spree_bank_details_on_seller_id", using: :btree

  create_table "spree_banner_products", force: :cascade do |t|
    t.integer "product_id"
  end

  create_table "spree_buyers", force: :cascade do |t|
    t.integer "user_id"
    t.string  "slug"
  ...
  add_index "spree_buyers", ["user_id"], name: "index_spree_buyers_on_user_id", using: :btree
  ...
  add_index "spree_line_items", ["store_order_id"], name: "index_spree_line_items_on_store_order_id", using: :btree
  ...
  create_table "spree_natty_picks", force: :cascade do |t|
    t.integer "taxon_id"
  end

  create_table "spree_newsletter_signups", force: :cascade do |t|
    t.text "email"
  end
  ...
  add_index "spree_option_types", ["store_id"], name: "index_spree_option_types_on_store_id", using: :btree
  ...
  create_table "spree_payu_in_payments", force: :cascade do |t|
    t.integer "payment_method_id"
    t.integer "user_id"
    t.integer "address_id"
    t.string  "mihpayid"
  ...
  add_index "spree_payu_in_payments", ["payment_method_id"], name: "index_spree_payu_in_payments_on_payment_method_id", using: :btree
  add_index "spree_payu_in_payments", ["user_id"], name: "index_spree_payu_in_payments_on_user_id", using: :btree
  ...
  create_table "spree_product_features", force: :cascade do |t|
    t.integer "product_id"
    t.text    "description_line"
  end

  add_index "spree_product_features", ["product_id"], name: "index_spree_product_features_on_product_id", using: :btree
  ...
  create_table "spree_product_samples", force: :cascade do |t|
    t.string  "name"
  ...
  add_index "spree_product_samples", ["store_id"], name: "index_spree_product_samples_on_store_id", using: :btree
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.string   "meta_title"
    t.integer  "store_id"
    t.string   "properties_label"
    t.string   "guide_label"
    t.integer  "status"
  end
  ...
  add_index "spree_prototypes", ["store_id"], name: "index_spree_prototypes_on_store_id", using: :btree
  ...
  create_table "spree_sample_store_taxons", force: :cascade do |t|
    t.integer "store_id"
    t.integer "taxon_id"
  end

  add_index "spree_sample_store_taxons", ["store_id"], name: "index_spree_sample_store_taxons_on_store_id", using: :btree
  add_index "spree_sample_store_taxons", ["taxon_id"], name: "index_spree_sample_store_taxons_on_taxon_id", using: :btree
  ...
  add_index "spree_sellers", ["user_id"], name: "index_spree_sellers_on_user_id", using: :btree
  ...
  create_table "spree_specifications", force: :cascade do |t|
    t.integer "product_id"
    t.text    "spec"
  end

  add_index "spree_specifications", ["product_id"], name: "index_spree_specifications_on_product_id", using: :btree
  ...
  add_index "spree_stock_locations", ["store_id"], name: "index_spree_stock_locations_on_store_id", using: :btree
  ...
  create_table "spree_store_orders", force: :cascade do |t|
    t.integer "order_id"
    t.integer "store_id"
  end

  add_index "spree_store_orders", ["order_id"], name: "index_spree_store_orders_on_order_id", using: :btree
  add_index "spree_store_orders", ["store_id"], name: "index_spree_store_orders_on_store_id", using: :btree
  ...
  create_table "spree_store_policies", force: :cascade do |t|
    t.integer "store_id"
    t.string  "heading"
    t.text    "description"
  end

  add_index "spree_store_policies", ["store_id"], name: "index_spree_store_policies_on_store_id", using: :btree
  ...
  add_index "spree_stores", ["seller_id"], name: "index_spree_stores_on_seller_id", using: :btree
  add_index "spree_stores", ["slug"], name: "index_spree_stores_on_slug", unique: true, using: :btree
  ...
  create_table "spree_trending_products", force: :cascade do |t|
    t.integer "product_id"
  end
  ...
  add_index "spree_user_addresses", ["buyer_id"], name: "index_spree_user_addresses_on_buyer_id", using: :btree
  add_index "spree_user_addresses", ["store_id"], name: "index_spree_user_addresses_on_store_id", using: :btree
  ...
  add_index "spree_users", ["provider"], name: "index_spree_users_on_provider", using: :btree
  add_index "spree_users", ["spree_api_key"], name: "index_spree_users_on_spree_api_key", using: :btree
  add_index "spree_users", ["uid"], name: "index_spree_users_on_uid", using: :btree
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.integer  "processing_days",                          default: 1
    t.string   "colour"
  end
